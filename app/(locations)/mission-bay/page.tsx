      ...
      <div className="bg-white dark:bg-[#111827] shadow-sm py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-8  text-gray-600 dark:text-gray-300 text-sm md:text-base">
            Mission Bay Center is conveniently located in a high traffic/high
            visibility location in the Mission Bay area of San Diego. This
            center has easy access to highways 5 and 52 as well as ample parking
            for customers, and currently has award winning restaurants, a
            convenience store, and many medical and professional tenants. It is
            near the Mission Bay Golf Course as well as the beach! The traffic
            count is approximately 31,360 ADT. The median income is
            approximately $71,000 with the average home price being $982,000.
            The immediate surrounding population is 48,000 with a density of
